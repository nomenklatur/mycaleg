          ...
          <div class="card mb-3 border-dark shadow rounded" style="max-width: 100%;">
            <div class="row g-0">
              <div class="col-lg-4 text-center">
                <img src="@if ($data->gambar === NULL) @if($data->jenis_kelamin === 'L') /images/male.png @else /images/female.png @endif @else {{asset('storage/'.$data->gambar)}}  @endif" class="img-fluid rounded-start" alt="..." style="max-width: 220px">
                <a href="/analisa/{{$data->uri}}/nbc" class="btn btn-outline-info rounded-pill mt-2">Analisa prediksi <i class="fa-solid fa-calculator ms-1"></i></a>
